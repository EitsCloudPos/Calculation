                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>{{trans('file.Lens')}}</th>
                                                        <th>{{trans('file.Cutting Charge')}}</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td><input type="number" class="form-control form-control-sm  lens" name="lens[]" value="{{$product_sale->lens}}" step="any" required/></td>
                                                        <td><input type="number" class="form-control form-control-sm  cutting-charge" name="cutting_charge[]" value="{{$product_sale->cutting_charge}}" step="any" required/></td>
                                                        <td><input type="number" class="form-control border  qty" name="qty[]" value="{{$product_sale->qty}}" step="any" required/></td>
...
<script type="text/javascript">
    ...
    function calculateRowProductData(quantity) {
        ...
        if (tax_method[rowindex] == 1) {
            ...
            var lens = parseFloat($('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.lens').val());
    var cutting_charge = parseFloat($('table.order-list tbody tr:nth-child(' + (rowindex + 1) + ')').find('.cutting-charge').val());

    var sub_total = lens + (cutting_charge * quantity);
